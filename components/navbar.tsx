          ...
          <div className="flex items-center flex-shrink-0">
            <Link href="/" className="flex items-center space-x-3 flex-shrink-0">
              ...
              <div className="flex flex-col min-w-0">
                <span className="font-bold text-white truncate text-[clamp(1rem,4vw,1.5rem)]">TANZIL EDUCATION CENTRE</span>
                <span className="text-sm text-teal-400 font-medium truncate">Knowledge and Values</span>
              </div>
            </Link>
          </div>
